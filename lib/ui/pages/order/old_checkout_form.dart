...
//     print(
//         "${widget.menu_type_id} pr lr:${DateFormat('hh:mm a').format(DateTime.now().add(Duration(hours: 2)))} - ${DateFormat('hh:mm a').format(DateTime.now().add(Duration(hours: 4)))} (2 hrs)");
...
//         time: widget.menu_type_id == 1
//             ? "${DateFormat('hh:mm a').format(DateTime.now())} - ${DateFormat('hh:mm a').format(DateTime.now().add(Duration(hours: 2)))} (2 hrs)"
...
//                   children: [
//                     VoucherWidget(
//                       isBuffet: checkBuffet(list: list),
//                       showEditButton: true,
//                       paymentType: widget.paymentType,
...
//                       date: widget.menu_type_id == 1
//                           ? "${DateFormat('hh:mm a').format(DateTime.now())} - ${DateFormat('hh:mm a').format(DateTime.now().add(Duration(hours: 2)))}"
